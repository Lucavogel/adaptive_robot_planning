...
class MoveItToPyBulletBridge(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('MoveIt to PyBullet Bridge started')
    ...
    def joint_state_callback(self, msg):
        ...
        try:
            ...
            if self.latest_joint_positions is None:
                ...
                if len(new_joint_positions) == len(self.latest_joint_positions):
                    for i, (new_pos, old_pos) in enumerate(zip(new_joint_positions, self.latest_joint_positions)):
            ...
            if significant_change:
                ...
                self.latest_joint_positions = new_joint_positions
                ...
                self.get_logger().info(f'Joint positions updated: {joint_info}')
